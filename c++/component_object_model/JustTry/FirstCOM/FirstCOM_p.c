...
typedef struct _FirstCOM_MIDL_TYPE_FORMAT_STRING
    {
    short          Pad;
    unsigned char  Format[ TYPE_FORMAT_STRING_SIZE ];
    } FirstCOM_MIDL_TYPE_FORMAT_STRING;

typedef struct _FirstCOM_MIDL_PROC_FORMAT_STRING
    {
    short          Pad;
    unsigned char  Format[ PROC_FORMAT_STRING_SIZE ];
    } FirstCOM_MIDL_PROC_FORMAT_STRING;

typedef struct _FirstCOM_MIDL_EXPR_FORMAT_STRING
    {
    long          Pad;
    unsigned char  Format[ EXPR_FORMAT_STRING_SIZE ];
    } FirstCOM_MIDL_EXPR_FORMAT_STRING;
...
extern const FirstCOM_MIDL_TYPE_FORMAT_STRING FirstCOM__MIDL_TypeFormatString;
extern const FirstCOM_MIDL_PROC_FORMAT_STRING FirstCOM__MIDL_ProcFormatString;
extern const FirstCOM_MIDL_EXPR_FORMAT_STRING FirstCOM__MIDL_ExprFormatString;
...
extern const MIDL_SERVER_INFO IFirstClass_ServerInfo;
extern const MIDL_STUBLESS_PROXY_INFO IFirstClass_ProxyInfo;
...
static const FirstCOM_MIDL_PROC_FORMAT_STRING FirstCOM__MIDL_ProcFormatString =
    {
        0,
        {
...
static const FirstCOM_MIDL_TYPE_FORMAT_STRING FirstCOM__MIDL_TypeFormatString =
    {
        0,
        {
			NdrFcShort( 0x0 ),	/* 0 */
...
static const MIDL_STUBLESS_PROXY_INFO IComponentRegistrar_ProxyInfo =
    {
    &Object_StubDesc,
    FirstCOM__MIDL_ProcFormatString.Format,
...
/* Object interface: IFirstClass, ver. 0.0,
   GUID={0x4E7BE470,0x309E,0x431F,{0x9A,0xC8,0xE9,0x73,0xF7,0xEA,0xCB,0x5F}} */

#pragma code_seg(".orpc")
static const unsigned short IFirstClass_FormatStringOffsetTable[] =
    {
    (unsigned short) -1,
    (unsigned short) -1,
    (unsigned short) -1,
...
static const MIDL_STUBLESS_PROXY_INFO IFirstClass_ProxyInfo =
    {
    &Object_StubDesc,
    FirstCOM__MIDL_ProcFormatString.Format,
    &IFirstClass_FormatStringOffsetTable[-3],
    0,
    0,
    0
    };
...
static const MIDL_SERVER_INFO IFirstClass_ServerInfo = 
    {
    &Object_StubDesc,
    0,
    FirstCOM__MIDL_ProcFormatString.Format,
    ...
    0,
    0};
CINTERFACE_PROXY_VTABLE(8) _IFirstClassProxyVtbl = 
{
    &IFirstClass_ProxyInfo,
    &IID_IFirstClass,
    IUnknown_QueryInterface_Proxy,
    IUnknown_AddRef_Proxy,
    IUnknown_Release_Proxy ,
    ...
    0 /* (void *) (INT_PTR) -1 /* IDispatch::GetIDsOfNames */ ,
    0 /* IDispatch_Invoke_Proxy */ ,
    (void *) (INT_PTR) -1 /* IFirstClass::Add */
};


static const PRPC_STUB_FUNCTION IFirstClass_table[] =
{
    STUB_FORWARDING_FUNCTION,
    STUB_FORWARDING_FUNCTION,
    STUB_FORWARDING_FUNCTION,
...
CInterfaceStubVtbl _IFirstClassStubVtbl =
{
    &IID_IFirstClass,
    &IFirstClass_ServerInfo,
    8,
    &IFirstClass_table[-3],
    CStdStubBuffer_DELEGATING_METHODS
};
...
static const MIDL_STUB_DESC Object_StubDesc = 
    ...
    0,
    0,
    FirstCOM__MIDL_TypeFormatString.Format,
...
const CInterfaceProxyVtbl * _FirstCOM_ProxyVtblList[] = 
{
    ( CInterfaceProxyVtbl *) &_IFirstClassProxyVtbl,
    ( CInterfaceProxyVtbl *) &_IComponentRegistrarProxyVtbl,
    0
};

const CInterfaceStubVtbl * _FirstCOM_StubVtblList[] = 
{
    ( CInterfaceStubVtbl *) &_IFirstClassStubVtbl,
    ( CInterfaceStubVtbl *) &_IComponentRegistrarStubVtbl,
    0
...
PCInterfaceName const _FirstCOM_InterfaceNamesList[] = 
{
    "IFirstClass",
    "IComponentRegistrar",
    0
...
const IID *  _FirstCOM_BaseIIDList[] = 
{
    &IID_IDispatch,
    &IID_IDispatch,
    0
...
#define _FirstCOM_CHECK_IID(n)	IID_GENERIC_CHECK_IID( _FirstCOM, pIID, n)

int __stdcall _FirstCOM_IID_Lookup( const IID * pIID, int * pIndex )
{
    IID_BS_LOOKUP_SETUP

    IID_BS_LOOKUP_INITIAL_TEST( _FirstCOM, 2, 1 )
    IID_BS_LOOKUP_RETURN_RESULT( _FirstCOM, 2, *pIndex )
    
}

const ExtendedProxyFileInfo FirstCOM_ProxyFileInfo = 
{
    (PCInterfaceProxyVtblList *) & _FirstCOM_ProxyVtblList,
    (PCInterfaceStubVtblList *) & _FirstCOM_StubVtblList,
    (const PCInterfaceName * ) & _FirstCOM_InterfaceNamesList,
    (const IID ** ) & _FirstCOM_BaseIIDList,
    & _FirstCOM_IID_Lookup, 
    2,
    2,
